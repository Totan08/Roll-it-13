...
while comp_score < game_goal and user_score < game_goal:
    ...
    double_comp = initial_comp[1]

    # Let user know if they qualify for a double points
    if double_user == "yes":
    ...
    while player_1_points < 13 and player_2_points < 13:
        ...
        # second person rolls the die (and the score is updated
    ...
    # work out who won and set the lower 3 points to zero...
    if user_points < comp_points:
        winner = "user"
        loser = "computer"
        comp_points = 0
    ...
    print(f"User Points: {user_points} | Comp Points: {comp_points}")
